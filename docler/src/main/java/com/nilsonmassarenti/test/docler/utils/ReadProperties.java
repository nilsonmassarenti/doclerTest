...
import com.nilsonmassarenti.test.docler.view.App;
...
public class ReadProperties {
	...
	public static Properties getProperties(){
		...
		try {
			InputStream in = App.class.getClassLoader().getResourceAsStream("com/nilsonmassarenti/test/resource/ping.properties");
			properties.load(in);
			return properties;
